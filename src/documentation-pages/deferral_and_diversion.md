...
This section presents data on cases granted diversion or deferred judgment. Diversion programs and deferred judgments are alternatives to traditional prosecution that attempt to address individuals’ needs. If programmatic requirements are met, the case will be dismissed.
...
Below are a set of Prosecutorial Performance Indicators that provide additional context about deferrals. These indicators help the District Attorney's office ensure they are deferring cases effectively and fairly.
