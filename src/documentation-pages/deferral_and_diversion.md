...
This section presents data on cases granted diversion or deferred judgment. <a href="#diversion">Diversion</a> and <a href="#deferred">deferred judgments</a> are alternatives to traditional prosecution that attempt to address individuals’ needs. If programmatic requirements are met, the case will be dismissed.
