...
This dashboard presents data on felony cases referred by law enforcement agencies to the DA’s office for review. The DA’s office decides whether to file charges, a formal accusation that a specific person has committed a specific crime. Each referral is represented once. The date represents when charges were either filed or declined for prosecution.  
